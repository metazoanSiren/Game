...
bool GameScene::OnCreate(){
	Debug::Info("Starting GameScene", "GameScene,cpp", __LINE__);
	...
	/*
	{
		...
		vertexList.push_back(v);
		v.position = glm::vec3(0.5f, 0.5f, 0.0f);
		v.colour = glm::vec3(0.0f, .0f, 1.0f);
		vertexList.push_back(v);
		v.position = glm::vec3(0.5f, -0.5f, 0.0f);
		v.colour = glm::vec3(0.0f, 1.0f, 0.0f);
		vertexList.push_back(v);
	...
	*/
	...
	TextureHandler::GetInstance()->CreateTexture("checkerborad",
		"./Resorces/Texture/CheckerboardTexture.png");

	model->AddMesh(new Mesh(&vertexList,
		ShaderHandler::GetInstance()->GetShader("basicShader"),
		TextureHandler::GetInstance()->GetTexture("checkerborad")));
